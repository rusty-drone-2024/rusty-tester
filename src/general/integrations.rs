...
pub fn test_drone_packet_1_hop<T: Drone + Send + 'static>() {
...
pub fn test_drone_packet_3_hop<T: Drone + Send + 'static>() {
...
pub fn test_drone_packet_3_hop_crash<T: Drone + Send + 'static>() {
    let net = Network::create_and_run::<T>(5, &[(0, 1), (1, 2), (2, 3), (3, 4)], &[0, 4]);
...
pub fn test_drone_packet_255_hop<T: Drone + Send + 'static>() {
...
pub fn test_drone_error_in_routing<T: Drone + Send + 'static>() {
...
pub fn test_drone_destination_is_drone<T: Drone + Send + 'static>() {
